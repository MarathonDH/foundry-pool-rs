...
pub struct HashrateResponse {
    ...
    #[serde(rename = "averageWorkers", skip_serializing_if = "Option::is_none")]
    pub average_workers: Option<f64>,
}

impl HashrateResponse {
    pub fn new(time: String, unix_time: i64, hashrate_accepted: i64, hashrate_stale: i64, hashrate_rejected: i64) -> HashrateResponse {
        HashrateResponse {
            time,
            end_time: None,
            unix_time,
